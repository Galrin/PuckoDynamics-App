...
import com.example.puckodynamics.databinding.BlockNowIfBinding
import com.example.puckodynamics.utils.toVisibility


@SuppressLint("ViewConstructor", "ClickableViewAccessibility")
class BlockNowIf(context: Context, rootView: ViewGroup) : BlockBase(context) {

    private var binding: BlockNowIfBinding

    init {
        binding = BlockNowIfBinding.inflate(LayoutInflater.from(context), rootView, false)
