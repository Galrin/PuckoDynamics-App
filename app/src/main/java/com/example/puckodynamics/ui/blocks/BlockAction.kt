...
class BlockAction(context: Context, rootView: ViewGroup) : BlockBase(context) {

    private var binding: BlockActionBinding

    init {
        binding = BlockActionBinding.inflate(LayoutInflater.from(context), rootView, false)
